...
Totals: backlog 18 · active 0 · review 7 · done 21 · blocked 0 · abandoned 5

| ID | Title | Type | Area | Phase | Status | Priority | Assignee |
| --- | --- | --- | --- | --- | --- | --- | --- |
| TW-051 | Migrate agent config from Cursor to generic + Claude Code | chore | repo | 0 | review | p2 | claude |
