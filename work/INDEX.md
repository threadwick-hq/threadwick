...
Totals: backlog 18 · active 1 · review 6 · done 25 · blocked 0 · abandoned 5

| ID | Title | Type | Area | Phase | Status | Priority | Assignee |
| --- | --- | --- | --- | --- | --- | --- | --- |
| TW-055 | Cut over work tracking to issue-first | chore | repo | 0 | active | p1 | agent |
...
| TW-053 | AI-tooling audit: container config bootstrap, gate fixes, doc corrections | chore | repo | 0 | done | p1 | claude |
| TW-054 | Issue-first work CLI backed by GitHub Issues | chore | repo | 0 | done | p1 | agent |
