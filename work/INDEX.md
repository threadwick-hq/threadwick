...
Totals: backlog 18 · active 1 · review 6 · done 21 · blocked 0 · abandoned 5

| ID | Title | Type | Area | Phase | Status | Priority | Assignee |
| --- | --- | --- | --- | --- | --- | --- | --- |
| TW-051 | Migrate agent config from Cursor to generic + Claude Code | chore | repo | 0 | active | p2 | claude |
