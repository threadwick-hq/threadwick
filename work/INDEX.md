...
Totals: backlog 40 · active 1 · review 0 · done 3 · blocked 0 · abandoned 5
...
| TW-011 | Move the store and imperative canvas controller into packages/editor behind an SSR-safe entry | refactor | packages/editor, apps/studio | 6 | active | p1 | agent |
...
| TW-026 | Land the maker-plane Project model (references, progress, status, follow-mode) in @threadwick/types | feat | packages/types | 6 | backlog | p1 | - |
