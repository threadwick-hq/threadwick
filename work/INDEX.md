...
Totals: backlog 31 · active 1 · review 1 · done 12 · blocked 0 · abandoned 5
...
| TW-028 | Build the Follow progress state machine, Undo and aggregation (FILE_VERSION 3 to 4) | feat | packages/editor, packages/types | 6 | active | p1 | agent |
