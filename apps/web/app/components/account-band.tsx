		...
		>
			<div className="rounded-2xl border border-border bg-accent px-6 py-12 text-center sm:px-14 sm:py-16">
				...
				<p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
					Start free right in your browser — your work stays with you. Create a
					free account when you’re ready for more: sync across your devices,
					keep cloud backups, and share your patterns. Your work is always yours
					— export it and walk away anytime, no lock-in.
				</p>
				<div className="mt-7">
					<OpenStudioButton />
				</div>
