...
export const values = confirmed<Value[]>([
	...
	{
		name: 'Warm & calm',
		description: 'Cozy and paper-like, never corporate, loud, or gamified.',
	},
	{
	...
	},
	{
		...
		description:
			'WCAG AA, every device, every age and ability; never colour-only.',
	},
	{
		name: 'One coherent home',
		description: 'Every surface feels like one app.',
	},
]);
...
export const products = confirmed<Surface[]>([
	{
		...
		audience: 'artists',
		description:
			'The chart designer (project page → editor); design the pattern. Local-first / no-account.',
	},
	{
		name: 'Marketplace',
		audience: 'everyone',
		description:
			'Discover · buy/sell · share; the home of the publishing/consumption layer.',
	},
	{
		name: 'Viewer',
		audience: 'makers',
		description:
			'Read-only follow mode (big chart + round tracker); make the pattern.',
	},
	{
		name: 'threadwick.com',
		audience: 'everyone',
	...
	},
	{
		...
		description:
			'Shared design system, org knowledge, types, and domain primitives (the base).',
	},
]);

// ── Controlled vocabulary / glossary ─────────────────────────────────────────
// biome-ignore-start lint/style/useNamingConvention: glossary keys are canonical domain terms (PascalCase).
export const glossary = confirmed<Record<string, string>>({
	...
	Artifact:
		'A view under a Component: Chart | Written instructions | Schematic.',
...
// biome-ignore-end lint/style/useNamingConvention: glossary keys are canonical domain terms (PascalCase).
...
export const legal = {
	...
	brandIp: draft(
		'"Threadwick" name + marks © Threadwick. Trademark status TBD.',
	),
	privacyPolicy: draft(
		'Formal privacy policy + terms of service TBD — owner to author before launch.',
	),
